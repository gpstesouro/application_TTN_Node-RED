...
2. Clique em ADD NEW INSTANCE. Agora a parte mais difícil, não tenha medo!:scream: Na linha de comando digite:
3.  `__docker container run -d -p 1880:1880 gpstesouro/ttn_gateways_rs__`
4. Quase lá! Em OPEN PORT digite __1880__. Uma nova janela se apresentará. Simplesmente, feche alguns popup de aviso e voilá!:pray: Chame o dashboard do Node-Red (coloque __ui__ após a primeira barra do URL: `http://.../__ui__`) e divirta-se...

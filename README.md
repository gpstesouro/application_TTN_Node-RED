...
2. Clique em ADD NEW INSTANCE. Agora a prte mais difícil, não tenha medo! Na linha de comando digite: __docker container run -d -p 1880:1880 gpstesouro/ttn_gateways_rs__

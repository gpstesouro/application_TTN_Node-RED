...
Agora sim ... eis o novo código [gw-management-v1.json](https://github.com/Mario-Camara/application_TTN_Node-RED/blob/main/gw-management-v1.json) a ser importado para o Node-RED, para aqueles interessados em implementar na sua respectiva região.
...
3. Agora, caso deseje uma solução personalizada e beirando um _designer_ profissional - com o requinte de um *_dashboard_* - não deixe de visitar o seguinte [link](https://github.com/bao-optimiz/TTN_Gateway_Node). Olha que belezura! E já testei ... **FUNCIONA BEM!**
...
2. Clique em + ADD NEW INSTANCE. Agora a parte mais difícil, não tenha receio! :scream: Na linha de comando digite:  `docker container run -d -p 1880:1880 gpstesouro/ttn_gateways_rs` \<enter\>. Espere até a tela preta parar de "pipocar", seu _container_ está sendo recheado de "gostosuras".

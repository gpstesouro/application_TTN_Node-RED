...
2. Clique em + ADD NEW INSTANCE. Agora a parte mais difícil, não tenha medo!:scream: Na linha de comando digite:  `docker container run -d -p 1880:1880 gpstesouro/ttn_gateways_rs` \<enter\>. Espere até a tela parar de "pipocar".
4. Quase lá! Clique em OPEN PORT e digite __1880__ \<OK\>. Uma nova janela se apresentará. Simplesmente, feche algumas janelas _popup_ de aviso e voilá!:pray: Finja que não vê o Node-Red e só chame o dashboard (coloque __ui__ após a primeira barra solitária da URL: `http://.../ui`) e divirta-se... __GET__

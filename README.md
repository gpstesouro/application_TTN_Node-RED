...
4. Quase lá! Clique em OPEN PORT e digite __1880__ <OK>. Uma nova janela se apresentará. Simplesmente, feche algumas janelas _popup_ de aviso e voilá!:pray: Chame o dashboard do Node-Red (coloque __ui__ após a primeira barra solitária do URL: `http://.../ui`) e divirta-se... __GET__
